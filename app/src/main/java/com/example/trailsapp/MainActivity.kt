...
import com.example.trailsapp.ui.theme.TrailsAppTheme
...
fun MasterDetailScreen(trails: List<Trail>) {
    ...
    MainAppBar(navController = navController) // AppBar z przyciskami kategorii
